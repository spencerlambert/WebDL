...
`rest` tells the url parser that you are accessing the RESTful interface.  Technically the `rest` can be removed, as it's the defaul interface.  The following are equivalent ways of doing the same thing.
