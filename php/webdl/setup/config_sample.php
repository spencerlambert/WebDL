<?php
//Database items
define("WEBDL_MASTER_DB_HOST","localhost");
...
define("WEBDL_MASTER_DB_SSL_CA_PATH",'/etc/mysql/ssl/ca-cert.pem');

define("WEBDL_MASTER_DB_TABLE_PREFIX", '');

define("WEBDL_TEMPLATE_NAME", 'default');
define("WEBDL_DEBUG",false);
