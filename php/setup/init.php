...
class SuperAutoloader {
    ...
    private static function initialize() {
        ...
        $working_dirs = glob(ABSPATH."*", GLOB_ONLYDIR);
        $next_dirs = array();
        $more_dirs = true;
    ...
    public static function load($class) {
        ...
        if ($found_class === false) {
            ...
            UserMessage::output($msg, 'init.php');
        }
...
spl_autoload_register('SuperAutoloader::load');

include_once(ABSPATH."/setup/config.php");
include_once(ABSPATH."/setup/defines.php");
