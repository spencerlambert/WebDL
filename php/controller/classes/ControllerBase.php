...
class ControllerBase {
    ...
    public function display_header() {
        $html = file_get_contents(ABSPATH."template/".TEMPLATE_NAME."/header.html");
        $html = $this->replace_data($html, true);
    }
    
    public function display_footer() {
        $html = file_get_contents(ABSPATH."template/".TEMPLATE_NAME."/footer.html");
        $html = $this->replace_data($html, true);
    }

    public function display_page() {
        $html = file_get_contents(ABSPATH."template/".TEMPLATE_NAME."/page.html");
        $html = $this->replace_data($html, true);        
    }

    public function display_not_found() {
        $html = file_get_contents(ABSPATH."template/".TEMPLATE_NAME."/not_found.html");
        $html = $this->replace_data($html, true);
    }
    ...
    public function load_page() {
        ...
        $sql = "SELECT * FROM ".MASTER_DB_NAME_WITH_PREFIX."Page WHERE Controller=:name AND Permalink=:permalink";
        ...
        $this->template_tag_replace['USER-MESSAGE'] = UserMessage::get_msg();
    ...
    public static function get_request_parts() {
        ...
        $controller_dirs = glob(ABSPATH."/controller/*", GLOB_ONLYDIR);
        $controllers = array();
